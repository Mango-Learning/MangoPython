    ...
    CodeInput: class extends HTMLElement {
        ...
        * to syntax-highlight it. */
        ...
        setup() {
			...
			//	let placeholder = this.getAttribute("placeholder") || "User input. Each input should be entered on a seperate line" || "";
			
			let placeholder = this.getAttribute("placeholder") || "This is the editor. Enter your Python code here." || "";
